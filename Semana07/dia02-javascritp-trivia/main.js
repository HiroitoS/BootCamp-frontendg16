  ...
  function showResultPage(event) {
    ...
    questionsAndResults.innerHTML = `
      <section class="flex flex-col px-4 py-6 text-center bg-green-600 border rounded-lg shadow">
        ...
        <p class="text-md font-medium text-gray-900 mb-4 text-white">Respondiste ${correctAnswersCounter} de 3</p>
  
        <p class="text-md font-medium text-gray-900 mb-4 text-white">Y este es tu puntaje: ${correctAnswersCounter}</p>
